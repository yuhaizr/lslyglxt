                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane in active">
                                	<h6>当前用户组</h6>
                                	<form action="/lslyglxt/index.php/Home/Role/setRoleMedule" method="post" id="rolemedule">
                                ...
                                <div id="action11" class="tab-pane">
              							 <h6>当前用户组</h6>
	                                   <form action="/lslyglxt/index.php/Home/Role/setActionList" method="post" id="rolemedule">
                                ...
                                <div id="profile11" class="tab-pane">
	                                   <h6>当前用户组</h6>
	                                   <form action="/lslyglxt/index.php/Home/Role/setRoleAction" method="post" id="rolemedule">
