             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form action="/lslyglxt/index.php/Home/Hotel/save" method="post"  ><!--enctype="multipart/form-data"  -->
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control"  name="start" id="start" value="<?php echo ($info["start"]); ?>" value="<?php echo ($info["average_price"]); ?>"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"  >
		                                     </div>
					                    </div>	
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">规模(房间数)</label>
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control"  name="totalnum" id="totalnum" value="<?php echo ($info["totalnum"]); ?>" value="<?php echo ($info["average_price"]); ?>"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
		                                     </div>
