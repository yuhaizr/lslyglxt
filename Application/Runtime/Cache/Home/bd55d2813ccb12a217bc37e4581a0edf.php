	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/lslyglxt/index.php/Home/Hotel/showList" method="get" >
   	                 <div class="search-box col-sm-3" >
	                		<div>
	                			<span class="input-icon">
	                				<input type="text" name='searchValue' value="<?php echo ($searchValue); ?>" class="form-control" id="searchValue" placeholder="请输入酒店名称或者地址">
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                            ...
		                            <td><?php echo ($vo["strategy"]); ?></td>
		                            <td><?php echo ($vo["addr"]); ?></td>
		                            <td><?php echo ($vo["cyear"]); ?></td>
		                            <td><?php echo ($vo["myear"]); ?></td>
		                			...
		                			<a href="/lslyglxt/index.php/Home/Hotel/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
		           					<a href="/lslyglxt/index.php/Home/Hotel/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button" style="display: none;" class=" my_modify_btn btn btn-primary">修改</a>
		           					<a href="/lslyglxt/index.php/Home/Hotel/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    style="display: none;" class=" my_del_btn btn btn-danger  delete">删除</a>
		                			</td>
