...
<head>
	...
	var __URL = '/lslyglxt/index.php/Home/TourRoute';
                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">庐山线路信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/lslyglxt/index.php/Home/TourRoute/save" method="post"  ><!--enctype="multipart/form-data"  -->
    					 				<?php if(!empty($info)): ?><input type="hidden" class="form-control" required="required"  name="id" value="<?php echo ($info["id"]); ?>" ><?php endif; ?>
					        
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">线路名称</label>
		                                     <div class="col-lg-6">
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">推荐理由</label>
		                                     <div class="col-lg-6">
		                      
		                                         <textarea name='reason' id='reason' rows="10" cols="100" ><?php echo ($info["reason"]); ?></textarea>
		                                         
		                                     </div>
					      				 </div>	
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">推荐价格(元)</label>
		                                     <div class="col-lg-6">
		                      
		                                         <input type="text" class="form-control"  name="price" id="price"  value="<?php echo ($info["price"]); ?>"  onkeyup="value=value.replace(/[^\d+\.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d+\.]/g,''))">
		                                         
		                                     </div>
					      				 </div>						                    
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >往返天数</label>
		                                     <div class="col-lg-3">
		                                   
		                                         <input type="text" class="form-control"  name="day_num" id="day_num"  value="<?php echo ($info["day_num"]); ?>"  onkeyup="value=value.replace(/[^\d+\.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d+\.]/g,''))"> 
		                                     </div>
					                    </div>
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >相关景点</label>
		                                     <div class="col-lg-3">
		                        
		               		   						<select  multiple="multiple"  id="scenic_spot_list_select" style="width:100%;">
						                            	<?php if(is_array($scenic_spot_list)): foreach($scenic_spot_list as $key=>$vo): ?><option <?php if( in_array($vo['id'], $info['scenic_spot_list']) ): ?>selected = "selected"<?php endif; ?>   value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>         
						                           	</select>                  
		                        				<input id='scenic_spot_list' name='scenic_spot_list' type="hidden">
					                    ...
					                    <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存庐山特产信息">
					                    	</div>
					                    </div>
					               		</form>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#scenic_spot_list_select').select2({
		    placeholder: "请选择相关景点",
		    allowClear: true
		});
	});

	$("#scenic_spot_list_select").change(function(){
		var scenic_spot_list_select = $("#scenic_spot_list_select").val();
		$("#scenic_spot_list").val(scenic_spot_list_select);
	});
