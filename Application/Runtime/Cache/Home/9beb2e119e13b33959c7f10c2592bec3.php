                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">意见反馈</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/lslyglxt/index.php/Home/Suggestion/add" method="post"  ><!--enctype="multipart/form-data"  -->

				
					  
	
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">意见反馈</label>
		                                     <div class="col-lg-6">
		                      
		                                         <textarea name='content' id='content' rows="10" cols="100" required="required"><?php echo ($info["content"]); ?></textarea>
