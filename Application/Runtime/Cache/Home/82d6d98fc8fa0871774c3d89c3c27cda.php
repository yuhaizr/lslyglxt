	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">庐山线路列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/lslyglxt/index.php/Home/TourRoute/showList" method="get" >
   	                 <div class="search-box col-sm-3" >
	                		<div>
	                			<span class="input-icon">
	                				<input type="text" name='searchValue' value="<?php echo ($searchValue); ?>" class="form-control" id="searchValue" placeholder="请输入线路名称">
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                            ...
		                            <td><?php echo ($vo["day_num"]); ?></td>
		                       
									<td><?php echo ($vo["scenic_spot_list"]); ?></td>
		                			<td>
		                		
		                			<a href="/lslyglxt/index.php/Home/TourRoute/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
		           					<a href="/lslyglxt/index.php/Home/TourRoute/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button" style="display: none;" class=" my_modify_btn btn btn-primary">修改</a>
		           					<a href="/lslyglxt/index.php/Home/TourRoute/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    style="display: none;" class=" my_del_btn btn btn-danger  delete">删除</a>
		                			</td>
