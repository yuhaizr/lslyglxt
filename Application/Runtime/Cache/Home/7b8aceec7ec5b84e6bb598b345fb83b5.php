             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form action="/lslyglxt/index.php/Home/Visitors/add" method="post"  ><!--enctype="multipart/form-data"  -->
					        			...
					        			<div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                         ...
		                                         <input type="text" class="form-control yearView" required="required"  name="date" id="date"   value="<?php echo ($info["date"]); ?>"  > 
		                                     </div>
					                    </div>
					                    <div class='row'>
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                         ...
		                                         <input type="text" class="form-control" required="required"  name="totalnum" id="totalnum"  value="<?php echo ($info["totalnum"]); ?>"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"> 
		                                     </div>
					                    </div>
					                    ...
					                    <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存人流量信息">
					                    	</div>
					                    </div>
					               		</form>
