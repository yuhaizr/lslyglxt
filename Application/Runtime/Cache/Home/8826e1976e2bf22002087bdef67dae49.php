                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">庐山特产信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/lslyglxt/index.php/Home/LocalProduct/save" method="post"  ><!--enctype="multipart/form-data"  -->
    					 				<?php if(!empty($info)): ?><input type="hidden" class="form-control" required="required"  name="id" value="<?php echo ($info["id"]); ?>" ><?php endif; ?>
					        
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">特产名称</label>
		                                     <div class="col-lg-6">
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">特产介绍</label>
		                                     <div class="col-lg-6">
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">最佳产地</label>
		                                     <div class="col-lg-6">
		                      
		                                         <textarea name='best_produc_area' id='best_produc_area' rows="10" cols="100" ><?php echo ($info["best_produc_area"]); ?></textarea>
		                                         
		                                     </div>
					      				 </div>						                    
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >均价</label>
		                                     <div class="col-lg-3">
		                                   
		                                         <input type="text" class="form-control"  name="average_price" id="average_price"  value="<?php echo ($info["average_price"]); ?>"  onkeyup="value=value.replace(/[^\d+\.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d+\.]/g,''))"> 
		                                     </div>
					                    </div>
					                     
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">单位</label>
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control"  name="unit" id="unit"  value="<?php echo ($info["unit"]); ?>" >
		                                     </div>
					                    </div>			                    
