             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form action="/lslyglxt/index.php/Home/LocalProduct/add" method="post"  ><!--enctype="multipart/form-data"  -->
					                    ...
					                    <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="添加庐山特产信息">
					                    	</div>
					                    </div>
					               		</form>
