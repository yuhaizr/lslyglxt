...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <!--     <a id="editabledatatable_new" href="/lslyglxt/index.php/Home/Role/roleAdd?type=menu" class="btn btn-default" >添加角色</a> -->
  <!--                   <div class="btn-group pull-right">
                ...
                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                    ...
                    <tbody>
						<?php if(is_array($roleinfolist)): foreach($roleinfolist as $key=>$value): ?><tr>
								<?php if(is_array($value)): foreach($value as $k=>$v): ?><td><?php echo ($v); ?></td><?php endforeach; endif; ?>
								<td>
                               	<!-- <a href="/lslyglxt/index.php/Home/Role/roleEdit?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a> -->
                               	<a href="/lslyglxt/index.php/Home/Role/roleAuth?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 授权</a>
                                <a href="/lslyglxt/index.php/Home/Role/roleUserList?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 用户列表</a>
                                <!-- <a href="/lslyglxt/index.php/Home/Role/Roledelete?id=<?php echo ($value["id"]); ?>" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 删除</a> -->
                            </td>
