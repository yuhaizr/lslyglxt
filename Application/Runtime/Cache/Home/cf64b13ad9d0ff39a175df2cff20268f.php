                 ...
                 <div class="col-lg-6 col-sm-6 col-xs-12">
                     <div class="widget radius-bordered">
                         ...
                         <div class="widget-body">
                             <form id="registrationForm" action="/lslyglxt/index.php/Home/Role/roleAdd" method="post" class="form-horizontal bv-form" >
                                 ...
                                 <div class="form-group has-feedback">
                                     ...
                                     <div class="col-lg-8">
                                         <input class="checkbox-slider slider-icon yesno" value="1" name="rolestatus" checked="checked" type="checkbox"><span class="text"></span></div>
                                 </div>
