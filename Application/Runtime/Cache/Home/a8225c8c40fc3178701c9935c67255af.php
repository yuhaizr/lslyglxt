	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">考勤列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/lslyglxt/index.php/Home/CheckWork/showList" method="get" >
	      				<div class="col-sm-3">
							<input type="text" value="<?php echo ($searchDate); ?>" class="form-control" name='searchDate' id="searchDate" placeholder="请选择日期">
						</div>
						<?php if( $is_show == "1"): ?><div class="search-box col-sm-3" >
                            <select  name="searchUid" id="searchUid" style="width:100%;">
                            	<option value="">请选择工作人员</option>
                            	<?php if(is_array($userList)): foreach($userList as $key=>$vo): ?><option <?php if( $vo['id'] == $searchUid ): ?>selected = "selected"<?php endif; ?>  value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; ?>         
                           	</select>
