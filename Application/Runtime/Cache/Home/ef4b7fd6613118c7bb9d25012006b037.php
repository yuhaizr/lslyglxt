...
<div class="row">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div class="table-toolbar">
                    	<form action="/lslyglxt/index.php/Home/User/userList">
                    	 <div class="search-box col-sm-3" >
			                		<div>
			                			<span class="input-icon">
			                				<input type="text" value="<?php echo ($nickname); ?>" name='nickname' id='nickname' class="form-control"  placeholder="请输入用户姓名">
       ...
       <?php if(is_array($userinfolist)): foreach($userinfolist as $key=>$value): ?><tr>
      		...
      		<td><?php echo ($value["status"]); ?></td>
      		 ...
      		 <td>
             <a href="#" onclick="jumpuseredit(<?php echo ($value["id"]); ?>)" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a>
             <a href="#" onclick="jumpuserdelete(<?php echo ($value["id"]); ?>)" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 删除</a>
            </td>
...
$(function(){/* 
	$('#searchUser').click(function(){
		...
		$.ajax({
			type: "POST",
			url: '/lslyglxt/index.php/Home/User/index',
			data: data,
			dataType: 'json',
			success: function(dt) {	
