                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         ...
                         <div class="widget-body">
                             <form id="registrationForm" action="/lslyglxt/index.php/Home/User/useradd" method="post" class="form-horizontal bv-form" >
                      
                                 <div class="form-group has-feedback">
                                     <label class="col-lg-4 control-label">账号</label>
                                     <div class="col-lg-4">
                                         <input type="text" class="form-control" name="account" required="required" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
