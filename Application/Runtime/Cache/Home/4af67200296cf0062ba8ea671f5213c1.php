...
<head>
	...
	var __URL = '/lslyglxt/index.php/Home/CheckWork';
                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">员工考勤</span>      
                         </div>
                         <div class="widget-body">
		                    ...
		                    <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
		                    	...
		                    	<?php if($starttime == "0"): ?><a class="btn btn-palegreen save_check_work" starttime ="<?php echo ($starttime); ?>" detype='starttime' type="submit" id="saveRecord"><?php echo ($today); ?>员工上班考勤</a>
		                    		<?php else: ?>
		                    		<a class="btn " type="submit" id="saveRecord">上班已考勤(<?php echo ($starttime); ?>)</a><?php endif; ?>
		                    	</div>
		                    	 <div class='col-lg-4 '>
		                    	 <?php if($endtime == "0"): ?><a class="btn btn-palegreen save_check_work" starttime ="<?php echo ($starttime); ?>" detype='endtime' type="submit" id="saveRecord" ><?php echo ($today); ?>员工下班考勤</a>
		                         		<?php else: ?>
		                    		<a class="btn " type="submit" id="saveRecord">下班已考勤(<?php echo ($endtime); ?>)</a><?php endif; ?>
		                    	</div>
		                    </div>
...
<script type="text/javascript">
	...
	$(function(){
		$(".save_check_work").click(function(){
			var detype = $(this).attr('detype');
			if('starttime' == detype){
				if(!confirm("确定进行上班考勤？确定后不能进行修改")){
					return false;
				}
			}else{
				...
				if($starttime == '0'){
					alert("你上班考勤没有完成，不能进行下班考勤");
					return false;
				}
				
				if(!confirm("确定进行下班考勤？确定后不能进行修改")){
					return false;
				}	
			...
			location.href = "/lslyglxt/index.php/Home/CheckWork/save?detype="+detype;
