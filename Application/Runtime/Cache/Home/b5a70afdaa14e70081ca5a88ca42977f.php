                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         ...
                         <div class="widget-body">
                             <form id="registrationForm" action="/lslyglxt/index.php/Home/Role/roleEdit?id=2" method="post" class="form-horizontal bv-form" >
                      
                                 <div class="form-group has-feedback">
                                     <label class="col-lg-4 control-label">角色名称</label>
                                     <div class="col-lg-8">
                                         <input type="text" class="form-control" name="name" value = "<?php echo ($roleinfo["name"]); ?>" required="required">
                                 ...
                                 <div class="form-group has-feedback">
                                     ...
                                     <div class="col-lg-8">
                                         <input type="text" class="form-control" name="remark" data-bv-notempty="true" data-bv-notempty-message="The password is required and cannot be empty"  data-bv-field="password" value="<?php echo ($roleinfo["remark"]); ?>">
                                     </div>
                                 </div>
